    ...
    fetch('https://fakestoreapi.com/products')
        ...
        .then(res => {
            for (var i = 0; i < res.length; i++) {
                // console.log()
                data.innerHTML += `<div class="card mycard m-3" style="width: 18rem;">
                <div class="imagediv">
        ...
        .then(res => {
            ...
            for (var i = 0; i < res.length; i++) {
                ...
                if (response.includes(input)) {
                    flag = flag + 1
                    // console.log("true")
                    data.innerHTML += `<div id="mycard" class="card mycard m-3" style="width: 18rem;">
            <div class="imagediv">
            <img class="card-img-top myimage" src="${res[i].image}" alt="Card image cap">
            </div>
            <div class="card-body">
...
function border() {
    ...
    setInterval(() => {
        if (uname.value !=""){
            ...
            uname.style.border = "1px Solid #00e7fe"
        }
        else{
        ...
        if (email.value != "" && email.value.match(emailFormat)) {
            email.style.border = "1px Solid #00e7fe"
        }
        else {
        ...
        if (password.value != "" && password.value.length > 7) {
            ...
            password.style.border = "1px Solid #00e7fe"
        }
        else {
